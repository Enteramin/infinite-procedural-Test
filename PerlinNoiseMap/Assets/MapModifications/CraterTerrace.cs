...
public static class CraterTerrace
{

    //Pseudorandomly sets Dots with sinus functions
    public static float[,] GenerateCraterTerrace(int chunkSize, float craterSize, float craterIntensity, float posX, float posY, float ellipseX, float ellipseY, bool weightenedAngle)
    {
