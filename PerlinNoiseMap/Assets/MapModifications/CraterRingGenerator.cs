...
public static class CraterRingGenerator
{
    ...
    public static float[,] GenerateCraterRing(int chunkSize, float craterSize, float craterIntensity, float posX, float posY, float ellipseX, float ellipseY, bool weightenedAngle, float modb)
    {
